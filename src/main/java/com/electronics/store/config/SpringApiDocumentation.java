...
//                )
                .info(new Info()
                        ...
                        .version("1.0")
                        .contact(new Contact().name("Faizan").email("mohdfaizan586@gmail.com"))
                        .license(new License().name("License Name"))
                ).externalDocs(new ExternalDocumentation().url("https://github.com/https://Shaikh-faizan786/ElectronicStore"))
                ;
    }
